...
<div class="page__section" >
  ...
  <h3 class="heading" style="font-family: Georgia, 'Times New Roman', Times, serif;margin-top:30px"> <span style="color: black;">Comments</span></h3>
            ...
            <?php
                ...
                $result1 = mysqli_query($conn,"SELECT * FROM comment");
                        ...
                        if(mysqli_num_rows($result1) <=0){
                                ...
                                echo '<table style="margin-left:15%;margin-bottom:100px;display:block;border-collapse: collapse; width: 1050px;"><tr class="table-head">';
