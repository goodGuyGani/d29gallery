...
<div class="page__section" >
    <div  class="breadcrumb breadcrumb_type5" aria-label="Breadcrumb" style="height: 54px;">
      <ol class="breadcrumb__list r-list" style="color: #333;">
        <li class="breadcrumb__group" style="margin-top:17px;margin-left:15px">
          ...
          <a href="artworks.php" class="breadcrumb__point r-link">Profile Information</a>
          <span class="breadcrumb__divider" aria-hidden="true"></span>
        </li>
        </li>
      </ol>
  ...
  <form class="form" action = "action_profile.php"enctype="multipart/form-data" method="POST" style="margin-left:100px;margin-right:100px">
...
while($row=mysqli_fetch_row($result_category))
{
  ...
  <label class="field">
    ...
    <input class="field__input" type="text" id="municipal" required name="municipal" value="<?php echo $municipal; ?>"/>
  </label>
  <label class="field">
    <span class="field__label" for="province" style="font-size: 12px;font-weight: bold;color:black">Province</span>
    <input class="field__input" type="text" id="province" required name="province" value="<?php echo $province; ?>"/>
  </label>
  <label class="field">
    <span class="field__label" for="Street" style="font-size: 12px;font-weight: bold;color:black">Street</span>
    <input class="field__input" type="text" id="Street" required name="Street" value="<?php echo $street; ?>"/>
  </label>
  <label class="fields fields--3">
    <label class="field">
      ...
      <input class="field__input" type="text" id="zipcode" required name="zipcode" value="<?php echo $zipcode; ?>"/>
    </label>
    <label class="field">
      <span class="field__label" for="Brgy" style="font-size: 12px;font-weight: bold;color:black">Barangay</span>
      <input class="field__input" type="text" id="Brgy" required name="Brgy" value="<?php echo $brgy; ?>"/>
    </label>
    <label class="field">
      <span class="field__label" for="house_num" style="font-size: 12px;font-weight: bold;color:black">House Number</span>
      <input class="field__input" type="text" id="House_num" required name="House_num" value="<?php echo $house; ?>">
      </input>
    </label>
    </div>
