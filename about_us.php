...
<section>
        <div class="about-content">
          <h1 style="color: #fd3e50">About Us</h1>
      </div>
      ...
      <div class="container">
          <div class="articles">
            <h3 style="color:white">
              ...
              <p style="color:gray">
                The vision of Muradkhaal Gallery is to be one of the world's leading online art galleries offering different types of art by different artists.

          </div> 
      <div class="imgs">
        <img src="pictures/profile/Gallery.png" style="margin-bottom:50px">
      </div>
    </div>
    </section>
