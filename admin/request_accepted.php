...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Accepted Commission Request
    </h6>
...
<!--
  ...
  <div class="card-body">
    ...
    $query = "SELECT * FROM user, commission_request WHERE commission_request.USER_ID = user.USER_ID AND commission_request.COM_STATUS = 'Accepted' ORDER BY COM_ID DESC LIMIT $start, $limit ";
    $query_run = mysqli_query($conn, $query);

    $result1 = $conn->query("SELECT count(COM_ID) AS COM_ID FROM commission_request WHERE commission_request.COM_STATUS = 'Accepted'");
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="request_accepted.php?page=<?= $Previous; ?>">Previous</a></li>
    <?php for($i = 1; $i <= $pages; $i++) : ?>
      <li class="page-item"><a class="page-link" href="request_accepted.php?page=<?= $i; ?>"><?= $i; ?></a></li>
    <?php endfor; ?>
    <li class="page-item"><a class="page-link" href="request_accepted.php?page=<?= $Next; ?>">Next</a></li>
  </ul>
</nav>
