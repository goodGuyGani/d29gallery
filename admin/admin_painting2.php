...
function YNconfirm() {
  ...
  <h3 class="heading" style="font-family: Georgia, 'Times New Roman', Times, serif;margin-top:30px"> <span>Painting Artworks</span></h3>
...
$query_category="SELECT art_work.art_imagepath,art_work.art_id, art_work.art_title,art_work.art_price, user.user_fname, user.user_mname,user.user_lname,art_work.art_description,art_work.art_imagepath,art_work.art_status,art_work.art_category
            FROM art_work,user
            where art_work.user_id = user.user_id AND art_work.art_category = 'Painting'  ORDER BY art_work.art_id DESC LIMIT $start, $limit";
            
            $result1 = $conn->query("SELECT count(ART_ID) AS ART_ID FROM art_work WHERE art_work.art_category = 'Painting'");
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="admin_painting2.php?page=<?= $Previous; ?>">Previous</a></li>
    <?php for($i = 1; $i <= $pages; $i++) : ?>
      <li class="page-item"><a class="page-link" href="admin_painting2.php?page=<?= $i; ?>"><?= $i; ?></a></li>
    <?php endfor; ?>
    <li class="page-item"><a class="page-link" href="admin_painting2.php?page=<?= $Next; ?>">Next</a></li>
  </ul>
</nav>
